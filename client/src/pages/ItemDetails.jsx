        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="rounded-3xl bg-white shadow p-8 order-2 md:order-1">
            ...
            <p className="mt-4 text-slate-600 leading-relaxed">
              A silver HP laptop was lost around the campus library.
              It has a small sticker on the back cover.
            </p>
            ...
            <button
              className="mt-8 flex items-center justify-center gap-2 w-full h-12 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600"
            >
              <CheckCircle size={18}/>
              Claim Item
            </button>
