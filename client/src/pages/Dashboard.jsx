      ...
      <main className="flex-1 p-6 md:p-10">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mt-2 text-slate-500">Track your lost items, claims, and reports.</p>
          </div>

          {/* Logout */}

          <button className="flex items-center gap-2 rounded-xl border border-red-200 px-5 py-3 text-red-500 hover:bg-red-50 transition">
            <LogOut size={18} />
            Logout
          </button>
        </div>
        ...
        <div className="mt-8 grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="mt-5 space-y-4">
              <ReportCard name="HP Laptop" status="Lost" location="Library" color="text-red-500" />
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="mt-5 space-y-4">
              <ClaimCard item="HP Laptop" status="Pending Approval" />

              <ClaimCard item="Backpack" status="Approved" />
            </div>
          </div>
        </div>
      </main>
