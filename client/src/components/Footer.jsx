  ...
  return (
    <footer className="bg-white border-t border-slate-200">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="group">
            ...
            <p className="mt-4 text-sm text-slate-500 leading-relaxed">
              Campus Lost & Found helps students report,
              discover, and recover lost items easily.
            </p>
      ...
      <div className="border-t border-slate-200 bg-slate-50 py-4 text-center text-sm text-slate-500">
        ...
        <span className="mx-1 font-semibold text-orange-500">
          Campus Lost & Found
        </span>
        All rights reserved.
