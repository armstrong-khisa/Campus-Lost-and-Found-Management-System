    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between p-5">
        ...
        <button
          ...
          className="mt-5 flex items-center justify-center gap-2 rounded-xl bg-orange-500 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-orange-600 hover:shadow-md"
        >
          View Details
          <ArrowRight
            size={16}
